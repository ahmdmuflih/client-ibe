...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="/sumbangan">
                      ...
                      <div class="sumbit-container">
                        ...
                        <div class="submit-rectangle">
                          <div class="rectangle-text">
                            <img src="\Photo\upload_icon.png" class="img-rectangle mx-auto d-block">
          ...
          <div class="thx-container">
            ...
            <div class="row align-items-start thx2-container">
              <div class="col thx">
                <div class="card thx">
                  <div class="thx-card-body">
                      <img src="\Photo\book1.png" width="123" height="170">
              ...
              <div class="col thx">
                <div class="card thx">
                  <div class="thx-card-body">
                      <img src="\Photo\book2.png" width="123" height="170">
              ...
              <div class="col thx">
                <div class="card thx">
                  <div class="thx-card-body">
                      <img src="\Photo\book3.png" width="123" height="170">
